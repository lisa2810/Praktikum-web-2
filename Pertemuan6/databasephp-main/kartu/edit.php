...
<form method="POST" action="proses.php">
  ...
  <div class="form-group row mt-2">
    ...
    <div class="col-8"> 
        <input id="nama" name="diskon" type="text" class="form-control" 
        value="<?= $card['diskon'] ?>">
      </div>
    </div>
  </div>
  ...
  <div class="form-group row mt-2">
    <label for="nama" class="col-4 col-form-label">Iuran</label> 
    <div class="col-8"> 
        <input id="nama" name="iuran" type="text" class="form-control" 
        value="<?= $card['iuran'] ?>">
      </div>
    </div>
  </div>
